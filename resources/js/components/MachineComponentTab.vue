      ...
      >
        <div class="flex justify-between items-start">
          ...
          <div class="flex items-center gap-3 ml-3">
            ...
            <!-- Edit/Delete -->
            <div v-if="canAddData || canDeleteData" class="flex flex-col gap-1">
              <button v-if="canAddData" @click.stop="$emit('edit', comp)" class="p-1.5 text-slate-400 hover:text-brand-gradation hover:bg-brand-cream rounded-lg cursor-pointer transition-colors" title="Edit">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>
              </button>
              <button v-if="canDeleteData" @click.stop="$emit('delete', comp)" class="p-1.5 text-slate-400 hover:text-red-500 hover:bg-red-50 rounded-lg cursor-pointer transition-colors" title="Hapus">
